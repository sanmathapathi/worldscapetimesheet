...
def session_datawrite():
    ...
    print(sunday_date + "-" + saturday_date)
...
def saved_sessiondatawrite():
    ...
    timesheet_data = (sunday_date + "-" + monday_date, str(hourtype_selected), sunday_date + ": " + str(hoursentry_data1), monday_date + ": " + str(hoursentry_data2), tuesday_date + ": " + str(hoursentry_data3), wednesday_date + ": " + str(hoursentry_data4), thursday_date + ": " + str(hoursentry_data5), friday_date + ": " + str(hoursentry_data6), saturday_date + ": " + str(hoursentry_data7), str(hoursentry_datanotes), 'Saved Draft')
...
def viewselectedtimesheet():
        ...
        Label(window, text = userselected + "\'s Timesheet Data", bg="white", font="none 12 bold") .place(x=1075, y=145)
        Label(window, text = "Hourtype Selected: " + hourtype_final, bg="white", font="none 12") .place(x=1075, y=170)
        Label(window, text = day1_final + " hour(s)", bg="white", font="none 12") .place(x=1075, y=200)
        Label(window, text = day2_final + " hour(s)", bg="white", font="none 12") .place(x=1075, y=230)
        Label(window, text = day3_final + " hour(s)", bg="white", font="none 12") .place(x=1075, y=260)
        Label(window, text = day4_final + " hour(s)", bg="white", font="none 12") .place(x=1075, y=290)
        Label(window, text = day5_final + " hour(s)", bg="white", font="none 12") .place(x=1075, y=330)
        Label(window, text = day6_final + " hour(s)", bg="white", font="none 12") .place(x=1075, y=370)
        Label(window, text = day7_final + " hour(s)", bg="white", font="none 12") .place(x=1075, y=410)
        Label(window, text = "Notes: " + notes_final, bg="white", font="none 12") .place(x=1075, y=450)
...
def manager_login():
    ...
    Label(window, text=" ", bg="white") .pack()
    Button(window, text="Login", width=10, height=1, bg="white", command=manager_login_verify) .pack()
...
def admin_login():
    ...
    Label(window, text=" ", bg="white") .pack()
    Button(window, text="Login", width=10, height=1, bg="white", command=admin_login_verify) .pack()
